program standalone
  ...
  integer:: idx,run_in,run_out,shot,error_flag
  integer:: iounit = 1
  ...
  write(*,'(a17,i7)')  ' shot          = ',standalone_in%shot
  ...
  call imas_open_env('ids',shot,run_in,idx,input_db,input_machine,'3')
  ...
  call smart(equilibrium_in,core_profiles_in,core_profiles_out,codeparam_smart, &
  ...
  if(error_flag.eq.0) then
     ...
     call imas_create_env('ids',shot,run_out,0,0,idx,local_db,local_machine,'3')
